...
.route.hiking_heide_k_n[route_name="Dresdner Heide, Nachtflügel"][zoom>=14]               { shield-file: url('img/symbols/dresdner_heide/nachtfluegel.16.png'); }
.route.hiking_heide_k_n[route_name="Dresdner Heide, Neuer Flügel"][zoom>=14]              { shield-file: url('img/symbols/dresdner_heide/neuer_fluegel.16.png'); }
.route.hiking_heide_k_n[route_name="Dresdner Heide, Neuer Weg"][zoom>=14]                 { shield-file: url('img/symbols/dresdner_heide/neuer_weg.16.png'); }
.route.hiking_heide_o_s[route_name="Dresdner Heide, Ochsensteig"][zoom>=14]               { shield-file: url('img/symbols/dresdner_heide/ochsensteig.16.png'); }
.route.hiking_heide_o_s[route_name="Dresdner Heide, Pillnitz-Moritzburger-Weg"][zoom>=14] { shield-file: url('img/symbols/dresdner_heide/pillnitz-moritzburger_weg.16.png'); }
.route.hiking_heide_o_s[route_name="Dresdner Heide, Reichsapfel"][zoom>=14]               { shield-file: url('img/symbols/dresdner_heide/reichsapfel.16.png'); }
...
.route.hiking_heide_o_s[route_name="Dresdner Heide, Runde 4"][zoom>=14]                   { shield-file: url('img/symbols/dresdner_heide/runde_4.16.png'); }
.route.hiking_heide_o_s[route_name="Dresdner Heide, Sandbrückenweg"][zoom>=14]            { shield-file: url('img/symbols/dresdner_heide/sandbrueckenweg.16.png'); }
.route.hiking_heide_o_s[route_name="Dresdner Heide, Saugartenweg"][zoom>=14]              { shield-file: url('img/symbols/dresdner_heide/saugartenweg.16.png'); }
.route.hiking_heide_o_s[route_name="Dresdner Heide, Schere"][zoom>=14]                    { shield-file: url('img/symbols/dresdner_heide/schere.16.png'); }
.route.hiking_heide_o_s[route_name="Dresdner Heide, Schwerterweg"][zoom>=14]              { shield-file: url('img/symbols/dresdner_heide/schwerterweg.16.png'); }
.route.hiking_heide_o_s[route_name="Dresdner Heide, Schwesternsteig"][zoom>=14]           { shield-file: url('img/symbols/dresdner_heide/schwesternsteig.16.png'); }
.route.hiking_heide_o_s[route_name="Dresdner Heide, Semmelweg"][zoom>=14]                 { shield-file: url('img/symbols/dresdner_heide/semmelweg.16.png'); }
.route.hiking_heide_o_s[route_name="Dresdner Heide, Stuhlweg"][zoom>=14]                  { shield-file: url('img/symbols/dresdner_heide/stuhlweg.16.png'); }
.route.hiking_heide_t_z[route_name="Dresdner Heide, Todweg"][zoom>=14]                    { shield-file: url('img/symbols/dresdner_heide/todweg.16.png'); }
.route.hiking_heide_t_z[route_name="Dresdner Heide, Topfweg"][zoom>=14]                   { shield-file: url('img/symbols/dresdner_heide/topfweg.16.png'); }
.route.hiking_heide_t_z[route_name="Dresdner Heide, Verkehrte Gabel"][zoom>=14]           { shield-file: url('img/symbols/dresdner_heide/verkehrte_gabel.16.png'); }
.route.hiking_heide_t_z[route_name="Dresdner Heide, Verkehrter Anker"][zoom>=14]          { shield-file: url('img/symbols/dresdner_heide/verkehrter_anker.16.png'); }
.route.hiking_heide_t_z[route_name="Dresdner Heide, Vogelzipfel"][zoom>=14]               { shield-file: url('img/symbols/dresdner_heide/vogelzipfel.16.png'); }
.route.hiking_heide_t_z[route_name="Dresdner Heide, Weißiger Gänsefuß"][zoom>=14]         { shield-file: url('img/symbols/dresdner_heide/weissiger_gaensefuss.16.png'); }
.route.hiking_heide_t_z[route_name="Dresdner Heide, Weißiger Weg"][zoom>=14]              { shield-file: url('img/symbols/dresdner_heide/weissiger_weg.16.png'); }
...
.route.hiking_heide_k_n[route_name="Dresdner Heide, Kreuz R"][zoom>=12]    { shield-file: url('img/symbols/dresdner_heide/Wegzeichen_Kreuz-R.8.png'); }
.route.hiking_heide_k_n[route_name="Dresdner Heide, Kuhschwanz"][zoom>=12] { shield-file: url('img/symbols/dresdner_heide/Wegzeichen_Kuhschwanz.8.png'); }
.route.hiking_heide_t_z[route_name="Dresdner Heide, Zirkel"][zoom>=12]     { shield-file: url('img/symbols/dresdner_heide/Wegzeichen_Zirkel.8.png'); }
...
.route.hiking_heide_t_z[route_name="Dresdner Heide, Zirkel"][zoom>=14]     { shield-file: url('img/symbols/dresdner_heide/Wegzeichen_Zirkel.10.png'); }
...
.route.hiking_heide_t_z[route_name="Dresdner Heide, Zirkel"][zoom>=15]     { shield-file: url('img/symbols/dresdner_heide/Wegzeichen_Zirkel.12.png'); }
