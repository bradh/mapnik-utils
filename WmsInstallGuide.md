...
This is a sample mapnik WMS server configuration, along with a testing [Openlayers map](http://mapnik-utils.googlecode.com/svn/example_code/wms/openlayers.html).
...
### Step 1 ###
  ...
  * Decide whether to run as wsgi,mod\_python,cgi,fastcgi (the server has wrappers for each)
  * If you want to run in fastcgi mode then install mod\_fastcgi or mod\_fcgi within apache
